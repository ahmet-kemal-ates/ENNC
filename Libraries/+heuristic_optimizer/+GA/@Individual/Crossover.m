...
function obj = Crossover(obj, partner)
...
crossoverMask = round(rand(obj.numParameters, 1)>obj.crossoverTh);

% Create the first son
obj.chromosome = crossoverMask.*partner.chromosome + (1-crossoverMask).*obj.chromosome;
end
